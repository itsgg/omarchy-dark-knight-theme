...
A Batman theme for [Omarchy](https://omarchy.org).

![Dark Knight](preview.png)

Dark blue-grey with a single accent colour. The palette is generated by a
script that checks contrast, so comments and dim text stay readable.
